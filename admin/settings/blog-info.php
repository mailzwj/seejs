...
<div class="set-wrap info-wrap">
    <form action="./info-save.php" method="post" id="J_InfoForm">
        ...
        <div class="ed-row">
            <label for="J_InfoLogo" class="label">博客LOGO</label><input type="text" name="logo" id="J_InfoLogo" class="input" placeholder="请上传博客LOGO(推荐：150x165)" value="<?php echo $data ? $data['logo'] : ''; ?>">
        ...
        <div class="ed-row">
            <label for="J_InfoName" class="label">博客名称</label><input type="text" name="sitename" id="J_InfoName" class="input" placeholder="请输入博客名称" value="<?php echo $data ? $data['sitename'] : ''; ?>">
        </div>
        <div class="ed-row">
            <label for="J_InfoSub" class="label">博客副标题</label><input type="text" name="subname" id="J_InfoSub" class="input" placeholder="请输入副标题" value="<?php echo $data ? $data['subname'] : ''; ?>">
        </div>
